package za.co.metropolitan.getup.client.exception.handler;
...
import za.co.metropolitan.getup.client.exception.model.ApiError;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException methodArgumentNotValidException, HttpHeaders headers, HttpStatus status, WebRequest webRequest) {
        ...
        return ResponseEntity.unprocessableEntity().body(new ApiError(HttpStatus.UNPROCESSABLE_ENTITY.value(), methodArgumentNotValidException.getMessage(), webRequest.getDescription(false), LocalDateTime.now()));
